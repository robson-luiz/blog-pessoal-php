    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Blog Protótipo</a>
            </div>
            <!-- Top Menu Items -->
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="posts_dropdown" class="collapse">
                            <li>
                                <a href="posts.php">Visualizar Posts</a>
                            </li>
                            <li>
                                <a href="posts.php?source=add_post">Adicionar Posts</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li class="active">
                        <a href="blank-page.html"><i class="fa fa-fw fa-file"></i>Comentarios</a>
                    </li>
                    <li>
